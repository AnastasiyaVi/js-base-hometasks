...
/*const productCards = document.querySelector(".products");    //НЕ ПОЛУЧИЛОСЬ =(((((
const buttonAll = document.querySelectorAll("button");
buttonAll.forEach((button) => {
   button.addEventListener('click', () => {
       const currentCategory = button.dataset.filter
       filter(currentCategory, productCards)
   });
})
...
*/
let productCards = document.querySelector(".products");  // т.к. не получилось, разбирала ваш вариант =(
...
function showCategory(category) {
    ...
    productCards.insertAdjacentHTML("afterbegin", markupToProductsDiv);
}
